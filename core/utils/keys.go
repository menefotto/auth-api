...
// GetPubblicKey returns and decode the pubblicKey
func GetPubblicKey() *rsa.PublicKey {
	data, _ := pem.Decode([]byte(pubblicKey))
...
// GetPrivateKey decode and returns the privateKey
...
var pubblicKey string = `-----BEGIN PUBLIC KEY-----
